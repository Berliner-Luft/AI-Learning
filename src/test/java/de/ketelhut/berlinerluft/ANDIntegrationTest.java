...
public class ANDIntegrationTest {
    ...
    @Before
    public void annInit() {
        ann = NeurophAND.trainNeuralNetwork(NeurophAND.assembleNeuralNetwork());
    }
    ...
    public void bothTrueConjunctTest() {
        ann.setInput(1, 1);
        ann.calculate();
        print("1, 1", ann.getOutput()[0], 1.0);
        assertEquals(ann.getOutput()[0], 1.0, 1.0);
    }
